      ...
      <div class="last-box row">
        ...
        <div class="partner-box text-center">
          ...
          <div class="text-muted text-left">
            <?php
                $imagenesAsociados = Utils::extraeElementosAleatorios($imagenesAsociados,3);
                foreach ($imagenesAsociados as $img) {
            ?>
                <ul class="list-inline">
                <li><img src="<?= $img->getUrlAsociados() ?>" alt="<?= $img->getDescripcion()?>"></li>
                <li><?= $img->getDescripcion()?></li>
                </ul>
            <?php
                }
            ?>
